...
export const RanksIcon = ({ active }) => (
  <svg width="24" height="24" viewBox="0 0 16 16" fill={active ? '#fff' : '#4B5563'}>
    <path d="M5.76 1.84c0 -0.9274999999999999 0.7525 -1.68 1.68 -1.68h1.1199999999999999c0.9274999999999999 0 1.68 0.7525 1.68 1.68v12.319999999999999c0 0.9274999999999999 -0.7525 1.68 -1.68 1.68h-1.1199999999999999c-0.9274999999999999 0 -1.68 -0.7525 -1.68 -1.68V1.84ZM0.16 8.56c0 -0.9274999999999999 0.7525 -1.68 1.68 -1.68h1.1199999999999999c0.9274999999999999 0 1.68 0.7525 1.68 1.68v5.6000000000000005c0 0.9274999999999999 -0.7525 1.68 -1.68 1.68H1.84c-0.9274999999999999 0 -1.68 -0.7525 -1.68 -1.68v-5.6000000000000005ZM13.04 2.4h1.1199999999999999c0.9274999999999999 0 1.68 0.7525 1.68 1.68v10.08c0 0.9274999999999999 -0.7525 1.68 -1.68 1.68h-1.1199999999999999c-0.9274999999999999 0 -1.68 -0.7525 -1.68 -1.68V4.079999999999999c0 -0.9274999999999999 0.7525 -1.68 1.68 -1.68Z" strokeWidth="0"/>
  </svg>
)
...
export const CommentIcon = ({ size = 22, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill={color}>
    <path d="M2 0C0.896875 0 0 0.896875 0 2v9c0 1.103125 0.896875 2 2 2h3v2.5c0 0.190625 0.10625 0.3625 0.275 0.446875s0.371875 0.065625 0.525 -0.046875L9.665625 13H14c1.103125 0 2 -0.896875 2 -2V2c0 -1.103125 -0.896875 -2 -2 -2H2z" strokeWidth="0"/>
  </svg>
)

export const LockIcon = ({ size = 22, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill={color}>
    <path d="M5.55 4.569999999999999v1.4699999999999998h4.8999999999999995v-1.4699999999999998c0 -1.3536249999999999 -1.0963749999999999 -2.4499999999999997 -2.4499999999999997 -2.4499999999999997s-2.4499999999999997 1.0963749999999999 -2.4499999999999997 2.4499999999999997Zm-1.96 1.4699999999999998v-1.4699999999999998C3.59 2.1353142857142857 5.565314285714286 0.16 8 0.16s4.41 1.9753142857142856 4.41 4.41v1.4699999999999998h0.49c1.0810642857142856 0 1.96 0.8789392857142856 1.96 1.96v5.879999999999999c0 1.0810607142857143 -0.8789357142857142 1.96 -1.96 1.96H3.0999999999999996c-1.0810607142857143 0 -1.96 -0.8789392857142856 -1.96 -1.96V8c0 -1.0810607142857143 0.8789392857142856 -1.96 1.96 -1.96h0.49Z" strokeWidth="0"/>
  </svg>
)

export const BoltIcon = ({ size = 22, color = 'currentColor', filled = false, pop = false }) => (
  <svg width={size} height={size} viewBox="0 0 16 16" fill={filled ? color : color}
    style={{
    ...
    <path d="M11.840239285714285 1.5261035714285713c0.18068214285714285 -0.41954642857142854 0.04593571428571428 -0.9095285714285714 -0.3246142857142857 -1.1790214285714284s-0.875842857142857 -0.24498928571428571 -1.2218928571428571 0.055125L2.4540071428571424 7.261964285714286c-0.3062392857142857 0.2694892857142857 -0.41648571428571424 0.7012857142857142 -0.27255 1.081025s0.511417857142857 0.636975 0.9187142857142857 0.636975h3.414567857142857l-2.3549785714285716 5.493932142857142c-0.18068214285714285 0.41954642857142854 -0.04593571428571428 0.9095285714285714 0.3246142857142857 1.1790214285714284s0.875842857142857 0.24498928571428571 1.2218928571428571 -0.055125L13.545992857142856 8.738035714285713c0.3062392857142857 -0.2694892857142857 0.41648214285714286 -0.7012857142857142 0.27255 -1.081025s-0.5083571428571428 -0.6339142857142858 -0.9187178571428571 -0.6339142857142858h-3.4145642857142855l2.3549785714285716 -5.496992857142857Z" strokeWidth="0"/>
  </svg>
)
