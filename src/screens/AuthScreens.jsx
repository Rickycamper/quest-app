  ...
  return (
    <div style={{
      ...
      <div style={{ padding: '0 28px 32px', width: '100%' }}>
        ...
        {/* OAuth error banner — ofrece dos salidas simples: reintentar Discord o entrar con email.
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      if (e?.isNetworkError || e?.name === 'AbortError' || /fetch|network|load failed/i.test(e?.message)) {
        ...
        // Antes, acá se mandaba AUTOMÁTICAMENTE un código por email y se
        // metía al usuario en la pantalla de código — que encima aceptaba 6
        // dígitos cuando el email traía 8. Cualquier error de tipeo en la
        // contraseña dejaba a la persona atrapada. Ahora: un mensaje normal.
        ...
        {error && (
          <div style={{ ...errorBox, display: 'flex', flexDirection: 'column', gap: 8 }}>
            ...
            {errorType === 'invalid_credentials' && (
              <span style={{ fontSize: 12, color: '#B91C1C', opacity: 0.85, lineHeight: 1.5 }}>
                ¿Te registraste con Discord? Entrá con Discord, o creá una contraseña desde «Forgot password?».
              </span>
            )}
