  ...
  return (
    <div ref={rootRef} style={isLandscape ? {
      ...
      <div style={{ flexShrink: 0, height: 10, background: 'transparent', position: 'relative', overflow: 'visible', zIndex: 20 }}>
        ...
        {/* Menú: pills RADIALES de acceso rápido (ref. video) + popup de
            LISTA con descripciones — las dos cosas conviven: las pills para
            lo frecuente, la lista para leer qué hace cada acción. */}
        {menuOpen && (
          <>
            <style>{`
              @keyframes lcPillIn {
